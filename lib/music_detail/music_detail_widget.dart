...
class MusicDetailWidget extends StatefulWidget {
  const MusicDetailWidget({
    Key key,
    this.musicRef,
  }) : super(key: key);

  final AlbumsRecord musicRef;

  @override
  _MusicDetailWidgetState createState() => _MusicDetailWidgetState();
}

class _MusicDetailWidgetState extends State<MusicDetailWidget> {
